...
public class TrainingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showAlert = (TextView)findViewById(R.id.showMsg);
        progBar = (ProgressBar)findViewById(R.id.progBarAct);
        progress.setMovementMethod(new ScrollingMovementMethod());

        showAlert.setText("Training! Don't exit until finished!!!");
    }
                    ...
                    if (persons.length > 0) {
                        ...
                        for (File person : persons) {
                            if (person.isDirectory()){
                                final File[] files = person.listFiles();
                                int counter = 1;
                                for (File file : files) {
...
//                                      fileHelper.saveCroppedImage(imgRgb, ppF, file, name, counter);
                                        ...
                                        progress.post(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                //progress.append("Don't exit until finished!!!");
                                               // progBar.getProgress();
                                            }
                                        });
                                        counter++;
                        ...
                        final Intent intent = new Intent(getApplicationContext(), MainFace.class);
